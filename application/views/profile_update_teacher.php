...
<div class="form-group">
  ...
  <div class="input-group">
     ...
     <input id="Department" name="Department" type="text" value="<?php foreach($details as $row){echo $row->Department;}?>" placeholder="Department" class="form-control input-md">
      </div>
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <textarea class="form-control" value="<?php foreach($details as $row){echo $row->Subjects;}?>"  rows="10"  id="Subjects" name="Subjects" placeholder="Subjects"><?php foreach($details as $row){echo $row->Subjects;}?></textarea>
  </div>
</div>
