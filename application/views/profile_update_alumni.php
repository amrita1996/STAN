...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="GradYear">GradYear</label>  
  <div class="col-md-4">
  ...
  <div class="input-group">
     ...
     <i class="fa fa-calendar"></i>
       ...
       <input id="GradYear" name="GradYear" type="text" value="<?php foreach($details as $row){echo $row->GradYear;}?>" placeholder="Graduated Year" class="form-control input-md">
      </div>
...
<div class="form-group">
  ...
  <div class="input-group">
    ...
    <input id="Experience" value="<?php foreach($details as $row){echo $row->Experience;}?>" name="Experience" type="text" placeholder="Experience" class="form-control input-md">
