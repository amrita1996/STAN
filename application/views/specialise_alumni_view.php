...
<div class="row">
<div class="col-md-10 ">
<form class="form-horizontal" name="splformstu" action="<?php echo base_url();?>index.php/register/alumni/<?php print_r($username)?>"  role="form" method="post">
<fieldset>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="GradYear">Graduated Year</label>  
  <div class="col-md-4">
  ...
  <div class="input-group">
     ...
     <i class="fa fa-birthday-cake"></i>
       ...
       <input id="GradYear" name="GradYear"  type="text" placeholder="GradYear" class="form-control input-md">
      </div>
...
<div class="form-group">
  ...
  <div class="input-group">
     ...
     <i class="fa fa-birthday-cake"></i>
       ...
       <input id="Experience" name="Experience"  type="text" placeholder="Experience" class="form-control input-md">
      </div>
